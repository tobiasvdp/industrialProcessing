...
public class ModelValve extends ModelConnectedFluidAnimated {
    ...
    @Override
    public void renderModelConnectedAnimated(TileEntity tl, float f, ConnectionState north, ConnectionState east, ConnectionState south, ConnectionState west, ConnectionState up, ConnectionState down, float[] animation) {
