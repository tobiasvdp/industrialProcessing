...
public class BlockWireStone extends BlockWire {

    public BlockWireStone() {
        super(ConfigMachineBlocks.getWireStoneBlockID(), Material.rock, Block.soundStoneFootstep, "Stone-embedded Wire");
    }
