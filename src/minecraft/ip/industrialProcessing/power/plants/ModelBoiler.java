...
public class ModelBoiler extends ModelAnimatedFluidMachine {
    ...
    public void renderLiquid(TileEntity tl, float f, int tankSlot, float fluidPercentage, Icon icon) {
        ...
        tessellator.addVertexWithUV((double) (x +  4) * f, (double) (yBot) * f, (double) (z + 0 ) * f, (double) icon.getMaxU() - uOffset, (double) icon.getMaxV());
        tessellator.addVertexWithUV((double) (x + w - 4) * f, (double) (yBot) * f, (double) (z + 0 ) * f, (double) icon.getMinU() + uOffset, (double) icon.getMaxV());
        tessellator.draw();
