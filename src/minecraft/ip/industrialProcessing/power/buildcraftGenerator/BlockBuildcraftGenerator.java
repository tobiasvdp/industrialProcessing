...
public class BlockBuildcraftGenerator extends BlockPowerGenerator {
	...
	super(ConfigMachineBlocks.getBuildcraftGeneratorBlockID(), Material.iron, 1F, Block.soundMetalFootstep, "Buildcraft Generator", IndustrialProcessing.tabMachines);
    }
    @Override
