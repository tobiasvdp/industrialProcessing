...
@NetworkMod(clientSideRequired = true, serverSideRequired = true, channels = {PacketHandler.channel,PacketHandler.DISPLAY_GET_NODES}, packetHandler = PacketHandler.class)
