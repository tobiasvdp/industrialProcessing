...
public class GuiLogicDisplay extends GuiScreen {
	...
	case interfaces:
		...
		case inventory:
			...
			fontRenderer.drawString("slot "+i+":(" + machine.slots.get(i).id + ") " + machine.slots.get(i).amount + ":" + machine.slots.get(i).damage, x + 45, y + 125+i*15, 4210752);
		    }
		    break;
		case power:
		...
		case tank:
			...
			fontRenderer.drawString("tank "+i+":(" + machine.tanks.get(i).fluidId + ") " + machine.tanks.get(i).amount + "/" + machine.tanks.get(i).capacity, x + 45, y + 125+i*15, 4210752);
		    }
		    break;
		case worker:
