...
public interface ISetupBlocks {
    public static final Block blockCopperOre = (new BlockOre(ConfigBlocks.BlockCopperOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockCopperOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockCopperOre").setCreativeTab(IndustrialProcessing.tabOres);;
    public static final Block blockTinOre = (new BlockOre(ConfigBlocks.BlockTinOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockTinOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockTinOre").setCreativeTab(IndustrialProcessing.tabOres);
    public static final Block blockGalenaOre = (new BlockOre(ConfigBlocks.BlockGalenaOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockGalenaOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockGalenaOre").setCreativeTab(IndustrialProcessing.tabOres);
    public static final Block blockRutileOre = (new BlockOreIP(ConfigBlocks.getBlockRutileOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockRutileOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockRutileOre").setCreativeTab(IndustrialProcessing.tabOres);
    public static final Block blockChromiteOre = (new BlockOre(ConfigBlocks.getBlockChromiteOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockChromiteOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockChromiteOre").setCreativeTab(IndustrialProcessing.tabOres);
    public static final Block blockCinnebarOre = (new BlockOreIP(ConfigBlocks.getBlockCinnebarOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockCinnebarOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockCinnebarOre").setCreativeTab(IndustrialProcessing.tabOres);
    public static final Block blockTaliaOre = (new BlockOre(ConfigBlocks.getBlockTaliaOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockTaliaOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockTaliaOre").setCreativeTab(IndustrialProcessing.tabOres);
    public static final Block blockBauxiteOre = (new BlockOre(ConfigBlocks.getBlockBauxiteID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockBauxiteOre").setTextureName(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockBauxiteOre").setCreativeTab(IndustrialProcessing.tabOres);
