...
public interface ISetupBlocks {
    ...
    public static final Block blockCinnebarOre = (new BlockOre(ConfigBlocks.getBlockCinnebarOreID())).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("blockCinnebarOre").func_111022_d(IndustrialProcessing.TEXTURE_NAME_PREFIX + "blockCinnebarOre").setCreativeTab(IndustrialProcessing.tabOres);
