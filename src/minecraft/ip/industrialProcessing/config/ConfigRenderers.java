...
public class ConfigRenderers {
	...
	// microblocks
	private int rendererMicroBlock;

	public static void setRendererMicroBlock(int var) {
		getInstance().rendererMicroBlock = var;
	}

	public static int getRendererMicroBlock() {
		return getInstance().rendererMicroBlock;
	}
	...
	public static void setRendererManualTreeTapID(int value) {
		getInstance().rendererManualTreeTapID = value;
	}

	public static int getRendererAutomaticTreeTapID() {
		return getInstance().rendererAutomaticTreeTapID;
	}

	public static void setRendererAutomaticTreeTapID(int value) {
		getInstance().rendererAutomaticTreeTapID = value;
	}
	...
	public static int getRendererConveyorPackerID() {
		return getInstance().rendererConveyorPackerId;
	}

	public static void setRendererConveyorPackerID(int value) {
		getInstance().rendererConveyorPackerId = value;
	}
