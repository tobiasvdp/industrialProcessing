...
import ip.industrialProcessing.power.plants.TileEntityElectricHeater;
import ip.industrialProcessing.power.plants.TileEntityFuelBurner;
...
import ip.industrialProcessing.transport.items.conveyorPacker.TileEntityConveyorPacker;
...
public class ConfigMachineBlocks {
    ...
    private int fuelBurnerBlockID = IndustrialProcessing.config.get(ConfigCategories.power.toString(), "FuelBurnerID", 808).getInt();
    private int electricHeaterBlockID = IndustrialProcessing.config.get(ConfigCategories.power.toString(), "ElectricHeaterID", 809).getInt();
    ...
    public static int getElectricHeaterBlockID() {
        return getInstance().electricHeaterBlockID;
    }

    public static int getFuelBurnerBlockID() {
        return getInstance().fuelBurnerBlockID;
    }
