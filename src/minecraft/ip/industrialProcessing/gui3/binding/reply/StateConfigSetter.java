...
public class StateConfigSetter extends TileSyncHandler implements IValueBindingChangedListener, IReplyBinding {
    private int index;
	...
	try {
	    writeTileEntity(outputStream, tileEntity); // 3 * 4 bytes
	...
	Packet250CustomPayload packet = getCustomPacket(bos, PacketHandler.GUI_STATECONF);
