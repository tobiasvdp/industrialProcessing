...
public class ObjConverter {
	...
	public static void main(String[] args) {
		...
		try {
			...
			cv.parseObjFile("C:\\Users\\Tobias\\Documents\\3dsMax\\export\\Bloomery.obj");
	...
	private void processGroupName(String line) {
		if (file != null) {
			...
			FileWriter outFile;
			try {
				//Stijn: outFile = new FileWriter("D:\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\machines\\flotationCell\\model\\"+file.title + ".java");
				outFile = new FileWriter("C:\\IndustrialProcessing\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\multiblock\\core\\block\\plants\\blacksmith\\bloomery\\model\\"+file.title + ".java");
