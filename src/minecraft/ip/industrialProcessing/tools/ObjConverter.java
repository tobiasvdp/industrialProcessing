...
public class ObjConverter {
	...
	public static void main(String[] args) {
		...
		try {
			//cv.parseObjFile("C:\\Users\\Stijn\\Documents\\3dsMax\\export\\Door.obj");
			cv.parseObjFile("C:\\Users\\Tobias\\Documents\\3dsMax\\export\\Door.obj");
	...
	private void processGroupName(String line) {
		if (file != null) {
			...
			try {
				...
				outFile = new FileWriter("C:\\IndustrialProcessing\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\decoration\\doors\\emergency\\model\\"+file.title + ".java");
				//outFile = new FileWriter("C:\\MinecraftForge\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\transport\\items\\conveyorInput\\model\\"+file.title + ".java");
