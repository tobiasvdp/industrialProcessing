...
public class ObjConverter {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//cv.parseObjFile("C:\\Users\\Tobias\\Documents\\3dsMax\\export\\StorageBox.obj");
	...
	private void processGroupName(String line) {
		if (file != null) {
			...
			try {
				...
				//outFile = new FileWriter("C:\\IndustrialProcessing\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\machines\\plants\\storage\\storageBox\\model\\"+file.title + ".java");
