...
public class ObjConverter {
	...
	private void processGroupName(String line) {
		if (file != null) {
			...
			FileWriter outFile;
			try {
				outFile = new FileWriter("D:\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\multiblock\\core\\block\\plants\\oilRefinary\\atmosphericDestilationTower\\model\\"+file.title + ".java");
