...
public class ObjConverter {
	...
	try {
	    //cv.parseObjFile("C:\\Users\\Stijn\\Documents\\3dsMax\\export\\floorTile.obj");
	     cv.parseObjFile("C:\\Users\\Tobias\\Documents\\3dsMax\\export\\BobCat.obj");
    ...
    private void processGroupName(String line) {
		if (file != null) {
			...
			try {
				...
				outFile = new FileWriter("C:\\IndustrialProcessing\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\subMod\\mine\\machines\\mining\\bobcatMiner\\model\\"+file.title + ".java");
