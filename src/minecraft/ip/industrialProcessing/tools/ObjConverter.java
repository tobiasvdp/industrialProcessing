...
public class ObjConverter {
    ...
    private void processGroupName(String line) {
        if (file != null) {
            ...
            FileWriter outFile;
            try {
                // Stijn Laptop: outFile = new
                // FileWriter("C:\\MinecraftForge\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\machines\\diskFilter\\model\\"+file.title
                // + ".java");
                // Stijn Desktop:
                outFile = new FileWriter("D:\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\machines\\redstoneInterface\\model\\" + file.title + ".java");

                // outFile = new
                // FileWriter("C:\\IndustrialProcessing\\forge1.6.4\\mcp\\src\\minecraft\\ip\\industrialProcessing\\subMod\\blackSmith\\plant\\forge\\model\\"
                // + file.title + ".java");

                // outFile = new
                // FileWriter("C:\\indproc\\forge-1.6.4-9.11.1.965-src\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\subMod\\blackSmith\\plant\\forge\\model\\"
                // + file.title + ".java");
                // outFile = new
                // FileWriter("C:\\MinecraftForge\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\machines\\plants\\metalProcessing\\sandCaster\\model\\"+file.title
                // + ".java");
