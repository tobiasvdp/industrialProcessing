...
public class ObjConverter {
	...
	public static void main(String[] args) {
		...
		try {
			...
			cv.parseObjFile("C:\\Users\\Tobias\\Documents\\3dsMax\\export\\ControleBox.obj");
	...
	private void processGroupName(String line) {
		if (file != null) {
			...
			try {
				...
				outFile = new FileWriter("C:\\IndustrialProcessing\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\multiblock\\dummy\\block\\controlBox\\model\\"+file.title + ".java");
