...
public class RecipesMixer extends RecipesMachine {
    ...
    public RecipesMixer() {
	addRecipe(ironSmallToSludge(3000, 3000));
	addRecipe(copperSmallToSludge(3000, 3000));
	addRecipe(tinSmallToSludge(3000, 3000));
	addRecipe(goldSmallToSludge(3000, 3000));
	addRecipe(galenaSmallToSludge(3000, 3000));
	addRecipe(chromiteSmallToSludge(3000, 3000));
	addRecipe(taliaSmallToSludge(3000, 3000));
    }
