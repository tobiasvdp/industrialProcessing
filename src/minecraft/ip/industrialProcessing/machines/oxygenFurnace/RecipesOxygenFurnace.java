...
public class RecipesOxygenFurnace extends RecipesMachine {
	...
	private void addDefaultRecipes() {
		...
		steel.inputs = new RecipeInputSlot[] { 
				new RecipeInputSlot(0,FluidRegistry.getFluidID(ISetupFluids.itemFluidPigIron.getName()),RecipeSlotType.TANK, 3000)};
		steel.outputs = new RecipeOutputSlot[] {
				new RecipeOutputSlot(1,FluidRegistry.getFluidID(ISetupFluids.itemFluidHotSteel.getName()),RecipeSlotType.TANK, 2400, 3000, 0.5)  };
		addRecipe(steel);
	}
}
