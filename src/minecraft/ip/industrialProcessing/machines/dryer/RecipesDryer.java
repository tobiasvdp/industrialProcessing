...
public class RecipesDryer extends RecipesMachine {
    ...
    public RecipesDryer() {
    	addRecipe(ironSludgeToCleanChunks(3000,3000));
    	addRecipe(copperSludgeToCleanChunks(3000,3000));
    	addRecipe(tinSludgeToCleanChunks(3000,3000));
    	addRecipe(goldSludgeToCleanChunks(3000,3000));
    	addRecipe(galenaSludgeToCleanChunks(3000,3000));
    	addRecipe(taliaSludgeToCleanChunks(3000,3000));
    	addRecipe(chromiteSludgeToCleanChunks(3000,3000));
    	addRecipe(gritSludgeToGrit(3000,3000));
    	addRecipe(residuToSand(3000,3000));
    }
