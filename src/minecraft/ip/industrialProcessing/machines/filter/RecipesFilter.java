...
public class RecipesFilter extends RecipesMachine {
	...
	addRecipe(copperCrushedToLarge(3000,3000));
	addRecipe(tinCrushedToLarge(3000,3000));
	addRecipe(ironCrushedToLarge(3000,3000));
	addRecipe(goldCrushedToLarge(3000,3000));
	addRecipe(galenaCrushedToLarge(3000,3000));
	addRecipe(chromiteCrushedToLarge(3000,3000));
	addRecipe(taliaCrushedToLarge(3000,3000));

	addRecipe(copperFineToDust(3000,3000));
	addRecipe(tinFineToDust(3000,3000));
	addRecipe(ironFineToDust(3000,3000));
	addRecipe(goldFineToDust(3000,3000));
	addRecipe(galenaFineToDust(3000,3000));
	addRecipe(chromiteFineToDust(3000,3000));
	addRecipe(taliaFineToDust(3000,3000));
    }
