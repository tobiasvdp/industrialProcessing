...
public class RecipesFilter extends RecipesMachine {
	public RecipesFilter() {
		...
		addRecipe(copperCrushedToLarge(3000));
		addRecipe(tinCrushedToLarge(3000));
		addRecipe(ironCrushedToLarge(3000));
		addRecipe(goldCrushedToLarge(3000));
		addRecipe(galenaCrushedToLarge(3000));
		addRecipe(chromiteCrushedToLarge(3000));
		addRecipe(taliaCrushedToLarge(3000));
		
		addRecipe(copperFineToDust(3000));
		addRecipe(tinFineToDust(3000));
		addRecipe(ironFineToDust(3000));
		addRecipe(goldFineToDust(3000));
		addRecipe(galenaFineToDust(3000));
		addRecipe(chromiteFineToDust(3000));
		addRecipe(taliaFineToDust(3000));
	}

	private Recipe taliaFineToDust(int i) {
	...
	private Recipe chromiteFineToDust(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe galenaFineToDust(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe goldFineToDust(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe ironFineToDust(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe tinFineToDust(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe copperFineToDust(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe taliaCrushedToLarge(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe chromiteCrushedToLarge(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe galenaCrushedToLarge(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe goldCrushedToLarge(int i) {
		Recipe recipe = new Recipe();
		recipe.workRequired = i;
	...
	private Recipe ironCrushedToLarge(int i) {
	...
	private Recipe tinCrushedToLarge(int i) {
	...
	private Recipe copperCrushedToLarge(int i) {
