...
public class ContainerTricklingFilter extends ContainerPoweredFluidWorkerMachine {
	...
	public ContainerTricklingFilter(InventoryPlayer inventoryPlayer, TileEntityTricklingFilter tileEntity) {
