...
public class GuiContainerWaterTreatmentStation extends GuiContainerPoweredFluidWorkerMachine {
	...
	public GuiContainerWaterTreatmentStation(InventoryPlayer inventoryPlayer, TileEntityWaterTreatmentStation tileEntity) {
		super(inventoryPlayer, tileEntity, new ContainerWaterTreatmentStation(inventoryPlayer, tileEntity), "Water treatment", "textures/gui/WaterTreatment.png");
