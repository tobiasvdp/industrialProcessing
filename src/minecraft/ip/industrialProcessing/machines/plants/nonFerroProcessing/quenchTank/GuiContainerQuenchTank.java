...
public class GuiContainerQuenchTank extends GuiContainerPoweredFluidWorkerMachine {
		...
		public GuiContainerQuenchTank(InventoryPlayer inventoryPlayer, TileEntityPoweredFluidWorkerMachine tileEntity) {
			super(inventoryPlayer, tileEntity, new ContainerQuenchTank(inventoryPlayer, tileEntity), "Quench tank", "textures/gui/QuenchTank.png"); 
		}
