...
public class RecipesSandCaster extends RecipesMachine {
	...
	private Recipe CastIronIngot(int work, int power) {
		...
		recipe.inputs = new RecipeInputSlot[] { new RecipeInputSlot(0, FluidRegistry.getFluidID(IndustrialProcessing.itemFluidPigIron.getName()), RecipeSlotType.TANK, 800),new RecipeInputSlot(0, IndustrialProcessing.itemSandCastIngot.itemID, RecipeSlotType.DAMAGEDITEM, 1) };
