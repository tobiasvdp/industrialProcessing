...
public class GuiContainerSandCaster  extends GuiContainerPoweredFluidWorkerMachine {
		...
		public GuiContainerSandCaster(InventoryPlayer inventoryPlayer, TileEntityPoweredFluidWorkerMachine tileEntity) {
			super(inventoryPlayer, tileEntity, new ContainerSandCaster(inventoryPlayer, tileEntity), "Sand caster", "textures/gui/SandCaster.png"); 
		}
