...
public class GuiContainerTurretLathe   extends GuiContainerPoweredFluidWorkerMachine {
		...
		public GuiContainerTurretLathe(InventoryPlayer inventoryPlayer, TileEntityPoweredFluidWorkerMachine tileEntity) {
			super(inventoryPlayer, tileEntity, new ContainerTurretLathe(inventoryPlayer, tileEntity), "Turret lathe", "textures/gui/TurretLathe.png"); 
		}
