...
public class ContainerMultiblockIOSelect  extends Container{

	private TileEntityMultiblockBlockInv tileEntity;

	public ContainerMultiblockIOSelect(InventoryPlayer inventoryPlayer, TileEntityMultiblockBlockInv entity) {
		tileEntity = entity;
