...
public class GuiContainerMultiblockIOSelect extends GuiContainer {
	...
	public GuiContainerMultiblockIOSelect(InventoryPlayer inventoryPlayer, TileEntityMultiblockBlockInv tileEntity, int type) {
		super(new ContainerMultiblockIOSelect(inventoryPlayer, tileEntity));
