...
public class GuiContainerSolderingIron extends GUImultiblock {
	...
	protected void drawGuiContainerForegroundLayer(int param1, int param2) {
		...
		fontRenderer.drawString("Soldering", xSize - 70, ySize - 96 + 2, 4210752);
	}
	...
	protected void mouseClicked(int par1, int par2, int par3) {
		...
		if(BUTTON_WELDING.clickedInside(par1-x, par2-y))
			openGuiOnServer(0);
			//player.openGui(IndustrialProcessing.instance, 0, te.worldObj, te.xCoord, te.yCoord, te.zCoord);
