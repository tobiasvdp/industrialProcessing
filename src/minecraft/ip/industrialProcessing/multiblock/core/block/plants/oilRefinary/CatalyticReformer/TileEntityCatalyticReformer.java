...
public class TileEntityCatalyticReformer extends TileEntityMultiblockCoreTankWorkerPowered  {
	private static StructureMultiblock structure;
	private static TierCollection tierRequirments;
	private static RecipesCatalyticReformer recipes = new RecipesCatalyticReformer();
	static {
		// set layout
		...
		int i = 0;
		layout.setCoreID(i++, 0, 1, IndustrialProcessing.blockCatalyticReformer.blockID);
	...
	public TileEntityCatalyticReformer(){
