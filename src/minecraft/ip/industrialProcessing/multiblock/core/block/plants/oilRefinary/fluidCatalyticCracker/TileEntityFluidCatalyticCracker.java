...
public class TileEntityFluidCatalyticCracker extends TileEntityMultiblockCoreTankWorkerPowered  {
	private static StructureMultiblock structure;
	private static TierCollection tierRequirments;
	private static RecipesFluidCatalyticCracker recipes = new RecipesFluidCatalyticCracker();
	static {
		// set layout
		...
		int i = 0;
		layout.setCoreID(i++, 0, 1, IndustrialProcessing.blockFluidCatalyticCracker.blockID);
	...
	public TileEntityFluidCatalyticCracker(){
