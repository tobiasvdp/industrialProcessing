...
public class BlockRubberLog extends Block {
    ...
    public BlockRubberLog() {
        super(ConfigBlocks.getRubberLogID(), Material.wood);
        this.setHardness(2.0F).setStepSound(soundWoodFootstep).setUnlocalizedName("rubber log");
    }
    ...
    public void registerIcons(IconRegister par1IconRegister) {
        this.side_icon = par1IconRegister.registerIcon(IndustrialTrees.getLogSideTexture(0));
        this.top_icon = par1IconRegister.registerIcon(IndustrialTrees.getLogTopTexture(0));
        this.side_carved_icon = par1IconRegister.registerIcon(IndustrialTrees.getSpecialLogSideTexture(0, "carved"));
    }
