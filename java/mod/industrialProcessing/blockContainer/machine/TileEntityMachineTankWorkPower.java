...
public class TileEntityMachineTankWorkPower extends TileEntityMachineTankWork  implements IPoweredMachine {
    ...
    public TileEntityMachineTankWorkPower(RecipesMachine recipes, LocalDirection powerInput, int powerCapacity, int maxWorkSpeed) {
        super(recipes);
