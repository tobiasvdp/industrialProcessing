...
public abstract class TileEntityTransport extends TileEntityBlockContainerIP implements IConnectedTile, ILine {
	...
	private TransportConnectionState getSupportState(ForgeDirection direction) {
		if (this.worldObj.getBlock(this.xCoord + direction.offsetX, this.yCoord + direction.offsetY, this.zCoord + direction.offsetZ).isNormalCube()) {
	...
	protected TileEntity getConnectionNeighbor(ForgeDirection direction) {
		return this.worldObj.getTileEntity(this.xCoord + direction.offsetX, this.yCoord + direction.offsetY, this.zCoord + direction.offsetZ);
	}
	...
	public void writeToNBT(NBTTagCompound par1nbtTagCompound) {
		...
		par1nbtTagCompound.setInteger("Line", line);
	}
	...
	public void readFromNBT(NBTTagCompound par1nbtTagCompound) {
		...
		line = par1nbtTagCompound.getInteger("Line");
	}
