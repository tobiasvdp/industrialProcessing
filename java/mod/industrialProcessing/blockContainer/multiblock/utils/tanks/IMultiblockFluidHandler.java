...
public interface IMultiblockFluidHandler {
     ...
     */
    int fill(int multiblockID, ForgeDirection from, FluidStack resource, boolean doFill);
     ...
     *         simulated) drained.
     */
    FluidStack drain(int multiblockID, ForgeDirection from, FluidStack resource, boolean doDrain);
     ...
     *         simulated) drained.
     */
    FluidStack drain(int multiblockID, ForgeDirection from, int maxDrain, boolean doDrain);
     ...
     */
    boolean canFill(int multiblockID, ForgeDirection from, Fluid fluid);
     ...
     */
    boolean canDrain(int multiblockID, ForgeDirection from, Fluid fluid);
     ...
     */
    FluidTankInfo[] getTankInfo(int multiblockID, ForgeDirection from);
}
