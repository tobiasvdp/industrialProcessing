...
public class EastRightCorner extends ObjMesh{
	public EastRightCorner(){
		...
		this.quads[3] = new ObjQuad(new Vector3f(0.6f, 1.0f, 0.8f),new Vector3f(0.6f, 0.6f, 0.8f),new Vector3f(0.6f, 0.6f, 1.0f),new Vector3f(0.6f, 1.0f, 1.0f),new Vector2f(0.0f, 1.0f),new Vector2f(1.0f, 1.0f),new Vector2f(1.0f, 0.0f),new Vector2f(0.0f, 0.0f),new Vector3f(-4.0f, 0.0f, 0.0f));
	}
	@Override
