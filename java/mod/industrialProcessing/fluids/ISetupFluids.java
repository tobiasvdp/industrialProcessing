...
public interface ISetupFluids {
	...
	public final static BlockFluid blockFluidParaffinicNaphtha = new BlockFluid(itemFluidParaffinicNaphtha, Material.water, true);
	public final static ItemIPBucket bucketParaffinicNaphtha = new ItemIPBucket(blockFluidParaffinicNaphtha);

	public final static ItemFluid itemFluidHeavyNaphtha = new ItemFluid("HeavyNaphtha", 1000, 1000);
	public final static BlockFluid blockFluidHeavyNaphtha = new BlockFluid(itemFluidHeavyNaphtha, Material.water, true);
	public final static ItemIPBucket bucketHeavyNaphtha = new ItemIPBucket(blockFluidHeavyNaphtha);

	public final static ItemFluid itemFluidHeavyVirginNaphtha = new ItemFluid("HeavyVirginNaphtha", 1000, 1000);
	public final static BlockFluid blockFluidHeavyVirginNaphtha = new BlockFluid(itemFluidHeavyVirginNaphtha, Material.water, true);
	public final static ItemIPBucket bucketHeavyVirginNaphtha = new ItemIPBucket(blockFluidHeavyVirginNaphtha);

	public final static ItemFluid itemFluidLightVacuumGasOil = new ItemFluid("LightVacuumGasOil", 1000, 1000);
	public final static BlockFluid blockFluidLightVacuumGasOil = new BlockFluid(itemFluidLightVacuumGasOil, Material.water, true);
	public final static ItemIPBucket bucketLightVacuumGasOil = new ItemIPBucket(blockFluidLightVacuumGasOil);

	public final static ItemFluid itemFluidHeavyvacuumGasOil = new ItemFluid("HeavyvacuumGasOil", 1000, 1000);
	public final static BlockFluid blockFluidHeavyvacuumGasOil = new BlockFluid(itemFluidHeavyvacuumGasOil, Material.water, true);
	public final static ItemIPBucket bucketHeavyvacuumGasOil = new ItemIPBucket(blockFluidHeavyvacuumGasOil);

	public final static ItemFluid itemFluidUntreatedKerosene = new ItemFluid("UntreatedKerosene", 1000, 1000);
	public final static BlockFluid blockFluidUntreatedKerosene = new BlockFluid(itemFluidUntreatedKerosene, Material.water, true);
	public final static ItemIPBucket bucketUntreatedKerosene = new ItemIPBucket(blockFluidUntreatedKerosene);

	public final static ItemFluid itemFluidKerosene = new ItemFluid("Kerosene", 1000, 1000);
	public final static BlockFluid blockFluidKerosene = new BlockFluid(itemFluidKerosene, Material.water, true);
	...
	public final static BlockFluid blockFluidUntreatedDieselOil = new BlockFluid(itemFluidUntreatedDieselOil, Material.water, true);
	...
	public final static BlockFluid blockFluidDieselOil = new BlockFluid(itemFluidDieselOil, Material.water, true);
	...
	public final static BlockFluid blockFluidGasOil = new BlockFluid(itemFluidGasOil, Material.water, true);
	...
	public final static BlockFluid blockFluidAtmosphericBottoms = new BlockFluid(itemFluidAtmosphericBottoms, Material.water, true);
	...
	public final static BlockFluid blockFluidMicrobialWater = new BlockFluid(itemFluidMicrobialWater, Material.water, true);
...
*/
	...
	public final static BlockFluid blockFluidPigIron = new BlockFluid(itemFluidPigIron, Material.fire, false);
	...
	public final static BlockFluid blockFluidHotSteel = new BlockFluid(itemFluidHotSteel, Material.fire, false);
	...
	public final static BlockFluid blockFluidExhaustGas = new BlockFluid(itemFluidExhaustGas, Material.water, false);

	public final static ItemFluid itemFluidSteam = new ItemFluid("Steam", 1000, 1000);
	public final static BlockFluid blockFluidSteam = new BlockFluid(itemFluidSteam, Material.water, false);


	public final static ItemFluid itemFluidGritSludge = new ItemFluid("gritSludge", 2000, 2000);
	public final static BlockFluid blockFluidGritSludge = new BlockFluid(itemFluidGritSludge, Material.water, false);
	...
	public final static BlockFluid blockFluidResidu = new BlockFluid(itemFluidResidu, Material.water, false);
	...
	public final static BlockFluid blockFluidAir = new BlockFluid(itemFluidAir, Material.water, false);

	public final static ItemFluid itemFluidCO2 = new ItemFluid("CO2", 1000, 1000);
	public final static BlockFluid blockFluidCO2 = new BlockFluid(itemFluidCO2, Material.water, false);

	public final static ItemFluid itemFluidH2 = new ItemFluid("H2", 1000, 1000);
	public final static BlockFluid blockFluidH2 = new BlockFluid(itemFluidH2, Material.water, false);

	public final static ItemFluid itemFluidH2S = new ItemFluid("H2S", 1000, 1000);
	public final static BlockFluid blockFluidH2S = new BlockFluid(itemFluidH2S, Material.water, false);

	public final static ItemFluid itemFluidIsoButane = new ItemFluid("IsoButane", 1000, 1000);
	public final static BlockFluid blockFluidIsoButane = new BlockFluid(itemFluidIsoButane, Material.water, false);

	public final static ItemFluid itemFluidButane = new ItemFluid("Butane", 1000, 1000);
	public final static BlockFluid blockFluidButane = new BlockFluid(itemFluidButane, Material.water, false);

	public final static ItemFluid itemFluidAlkylate = new ItemFluid("Alkylate", 1000, 1000);
	public final static BlockFluid blockFluidAlkylate = new BlockFluid(itemFluidAlkylate, Material.water, false);

	public final static ItemFluid itemFluidGasMix = new ItemFluid("GasMix", 1000, 1000);
	public final static BlockFluid blockFluidGasMix = new BlockFluid(itemFluidGasMix, Material.water, false);

	public final static ItemFluid itemFluidFuelGas = new ItemFluid("FuelGas", 1000, 1000);
	public final static BlockFluid blockFluidFuelGas = new BlockFluid(itemFluidFuelGas, Material.water, false);
