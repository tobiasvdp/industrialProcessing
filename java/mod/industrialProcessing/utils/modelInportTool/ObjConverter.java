...
public class ObjConverter {
	...
	public static void main(String[] args) {
		...
		try {
			...
			cv.parseObjFile("C:\\Users\\Tobias\\Documents\\3dsMax\\export\\WindMill.obj");
	...
	private void processGroupName(String line) {
		if (file != null) {
			...
			try {
				...
				// + ".java");
				// Stijn Desktop: outFile = new
				// FileWriter("D:\\Minecraft\\forge\\mcp\\src\\minecraft\\ip\\industrialProcessing\\machines\\flotationCell\\model\\"+file.title
				// + ".java");
				
				outFile = new FileWriter("C:\\IndustrialProcessing\\forge1.7.2.1060\\src\\main\\java\\mod\\industrialProcessing\\plants\\industrialAge\\windMill\\model\\" + file.title + ".java");
