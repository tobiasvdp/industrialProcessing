...
public class ItemTransfers {
	...
	public static void launchEntireInventory(IInventory inventory, World world, float x, float y, float z, float dx, float dy, float dz) {
		for (int i = 0; i < inventory.getSizeInventory(); i++) {
			ItemStack stack = inventory.getStackInSlot(i);
			if (stack != null) {
				ItemTransfers.launch(stack, world, x, y, z, 0, 1, 0);
