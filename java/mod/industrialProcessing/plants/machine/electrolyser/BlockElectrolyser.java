...
public class BlockElectrolyser extends BlockMachineRendered implements IRecipeBlock, IGuiBlock {
    ...
    private static IGuiBuilder guiBuilder = new GuiBuilderDefault("Electrolyser").enablePower(0).addInputTank(0).addInputTank(1).enableWorker(WORKER_TEXTURE).addOutputTank(2).addOutputTank(3);
