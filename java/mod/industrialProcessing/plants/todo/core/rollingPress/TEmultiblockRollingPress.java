...
public class TEmultiblockRollingPress extends TileEntityMultiblockCoreInv {
	...
	static{
		...
		layout.setBlockID(-2, 1, -1,2, 0,0, ISetupMachineBlocks.BLmultiblockInvInput.blockID);
		...
		layout.setBlockID(0, 1, -1,13, 0,1, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(1, 1, -1,14, 0,1, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(0, 1, -2,15, 0,1, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(1, 1, -2,16, 0,1, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(0, 2, -1,17, 0,0, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(1, 2, -1,18, 0,0, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(0, 2, -2,19, 0,0, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		layout.setBlockID(1, 2, -2,20, 0,0, ISetupMachineBlocks.BLmultiblockWheel.blockID);
		
		layout.setCoreID(0,1,0, ISetupMachineBlocks.BLmultiblockRollingPress.blockID);
