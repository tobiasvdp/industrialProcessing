...
public class GuiContainerFluidCatalyticCracker extends GUImultiblock {
	...
	public GuiContainerFluidCatalyticCracker(InventoryPlayer inventory, TileEntityMultiblockCoreTankWorkerPowered core){
		super(inventory, core, new ContainerFluidCatalyticCracker(inventory, core), "Fluid catalytic cracker", "textures/gui/FluidCatalyticCracker.png");
	}
