...
public class GuiContainerVacuumDestilationTower extends GUImultiblock {
	...
	public GuiContainerVacuumDestilationTower(InventoryPlayer inventory, TileEntityMultiblockCoreTankWorkerPowered core){
		super(inventory, core, new ContainerVacuumDestilationTower(inventory, core), "Vacuum destilation tower", "textures/gui/VacuumDestilationTower.png");
	}
