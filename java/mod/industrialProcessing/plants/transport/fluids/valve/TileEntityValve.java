...
public class TileEntityValve extends TileEntityTransportFluidsBase implements IAnimationProgress, IAnimationSyncable, IRotateableEntity {
    ...
    public void readFromNBT(NBTTagCompound par1nbtTagCompound) {
        ...
        this.frontDirection = ForgeDirection.getOrientation(par1nbtTagCompound.getInteger("Front"));

        NBTTagList list = par1nbtTagCompound.getTagList("Tanks",10);
    ...
    public void writeToNBT(NBTTagCompound par1nbtTagCompound) {
        ...
        par1nbtTagCompound.setInteger("Front", this.frontDirection.ordinal());
