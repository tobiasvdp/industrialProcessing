package mod.industrialProcessing.plants.middleAge.anvil;
...
public class ContainerAnvil extends Container {
	...
	AnvilCraftingManager.getInstance().addRecipe(new ItemStack(ISetupItems.itemIronTips, 12), "xzx", " x ", "x x", 'x', new ItemStack(Items.iron_ingot), 'z', new ItemStack(ISetupItems.itemHammer, 1, WILDCARD_VALUE));
	AnvilCraftingManager.getInstance().addRecipe(new ItemStack(ISetupItems.itemIronPlate, 4), "xx ", "xx ", "  z", 'x', new ItemStack(Items.iron_ingot), 'z', new ItemStack(ISetupItems.itemHammer, 1, WILDCARD_VALUE));
	...
	AnvilCraftingManager.getInstance().addRecipe(new ItemStack(ISetupItems.itemIronBar, 8), "  x", " x ", "x z", 'x', new ItemStack(Items.iron_ingot), 'z', new ItemStack(ISetupItems.itemHammer, 1, WILDCARD_VALUE));
	...
	AnvilCraftingManager.getInstance().addRecipe(new ItemStack(ISetupItems.itemIronBowl, 3), " z ", "x x", " x ", 'x', new ItemStack(Items.iron_ingot), 'z', new ItemStack(ISetupItems.itemHammer, 1, WILDCARD_VALUE));
	AnvilCraftingManager.getInstance().addRecipe(new ItemStack(ISetupItems.itemHammer), "   ", " y ", "x  ", 'x', new ItemStack(ISetupItems.itemThickStick), 'y', new ItemStack(Items.iron_ingot));
    }
	...
	return this.worldObj.getBlock(this.posX, this.posY, this.posZ) != IndustrialProcessing.blockAnvil ? false : par1EntityPlayer.getDistanceSq(this.posX + 0.5D, this.posY + 0.5D, this.posZ + 0.5D) <= 64.0D;
    }
