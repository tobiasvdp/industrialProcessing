...
public class GuiContainerAlkylationUnit  extends GuiContainerPoweredFluidWorkerMachine{
	...
	public GuiContainerAlkylationUnit(InventoryPlayer inventoryPlayer, TileEntityAlkylationUnit tileEntity) {
		super(inventoryPlayer, tileEntity, new ContainerAlkylationUnit(inventoryPlayer, tileEntity), "Alkylation unit", "textures/gui/AlkylationUnit.png");
	}
