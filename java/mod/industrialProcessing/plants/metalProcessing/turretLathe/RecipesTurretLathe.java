...
public class RecipesTurretLathe extends RecipesMachine {
    public RecipesTurretLathe() {
	addDefaultRecipes();
    }
	...
	recipe.inputs = new RecipeInputInventorySlot[] { new RecipeInputInventorySlot(0, FluidRegistry.getFluidID(ISetupFluids.itemFluidPigIron.getName()), RecipeSlotType.TANK, 800), new RecipeInputInventorySlot(0, Item.bone.itemID, RecipeSlotType.INVENTORY, 1) };
