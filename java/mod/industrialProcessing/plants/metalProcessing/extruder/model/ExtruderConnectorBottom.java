...
public class ExtruderConnectorBottom extends ObjMesh{
	public ExtruderConnectorBottom(){
		...
		this.quads[12] = new ObjQuad(new Vector3f(0.3f, 0.3f, -0.2998f),new Vector3f(-0.3f, 0.3f, -0.2998f),new Vector3f(-0.3f, 0.3f, 0.3002f),new Vector3f(0.3f, 0.3f, 0.3002f),new Vector2f(0.6254f, 1.0001f),new Vector2f(0.6254f, 0.6251f),new Vector2f(1.0004f, 0.6251f),new Vector2f(1.0004f, 1.0001f),new Vector3f(0.0f, 4.0f, 0.0f));
		this.quads[13] = new ObjQuad(new Vector3f(-0.3f, 0.3f, -0.2998f),new Vector3f(0.3f, 0.3f, -0.2998f),new Vector3f(-0.0f, 0.3f, -0.2998f),new Vector2f(1.0005f, 0.2498f),new Vector2f(1.0005f, 0.6248f),new Vector2f(1.0005f, 0.4373f),new Vector3f(0.0f, -1.7205f, -2.4575999f));
	}
	@Override
