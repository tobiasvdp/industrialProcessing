...
import mod.industrialProcessing.blockContainer.light.BlockLamp;
...
public class BlockTorch extends BlockLamp {
	...
	public BlockTorch() {
		super(1f,1f, Material.wood,Block.soundTypeWood, "torch_on","torch_off");
	}
	...
	public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
		return par1World.isSideSolid(par2 - 1, par3, par4, ForgeDirection.EAST, true) || par1World.isSideSolid(par2 + 1, par3, par4, ForgeDirection.WEST, true) || par1World.isSideSolid(par2, par3, par4 - 1, ForgeDirection.SOUTH, true) || par1World.isSideSolid(par2, par3, par4 + 1, ForgeDirection.NORTH, true) || canPlaceTorchOn(par1World, par2, par3 - 1, par4);
	}
