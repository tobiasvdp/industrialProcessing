...
import mod.industrialProcessing.power.wire.WireConnection;
import mod.industrialProcessing.power.wire.WireLocation;
import mod.industrialProcessing.power.wire.WireNetworkMap;
...
public class TileEntityWire extends TileEntityTransport implements IPowerAcceptor {
	...
	private IPowerAcceptor getAcceptorAt(WireLocation wireLocation) {
		TileEntity entity = this.worldObj.getTileEntity(wireLocation.x, wireLocation.y, wireLocation.z);
