...
import mod.industrialProcessing.plants.power.wire.BlockWireStone;
import mod.industrialProcessing.plants.power.wire.BlockWireWood;
...
public class ModelWireBlock extends ModelBlock {
    ...
    public void renderInventory(Block block, int metadata, int modelID, RenderBlocks renderer) {
        ...
        if (block instanceof BlockWireWood || block instanceof BlockWireStone) {
        	IIcon caseIcon;
            if (block instanceof BlockWireWood)
    ...
    public boolean renderWorldBlock(WorldReference reference, int modelId, RenderBlocks renderer) {
        ...
        if (reference.block instanceof BlockWireWood || reference.block instanceof BlockWireStone) {
            renderer.renderAllFaces = true;
            IIcon icon = reference.getIcon(0);
            IIcon caseIcon;
            if (reference.block instanceof BlockWireWood)
