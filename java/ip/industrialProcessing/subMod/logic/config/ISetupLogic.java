...
public interface ISetupLogic {
	...
	public final static ItemMicroBlock itemMicroblockWire = new ItemMicroBlock(ConfigLogic.getItemMicroblockDatabusID(),"ItemMicroBlockDatabus",IPLogic.tabLogic,ConfigLogic.setRendererMicroblockDataBus(MicroBlockModelRegistry.getNextAvailableID()),MicroBlockType.wire,"TileEntityDataBus",0);
