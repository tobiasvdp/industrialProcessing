...
public class TileEntityDelayedCoker extends TileEntityMultiblockCoreTankWorkerPowered  {
	private static StructureMultiblock structure;
	private static TierCollection tierRequirments;
	private static RecipesMultiblock recipes = new RecipesDelayedCoker();
	static {
		// set layout
		...
		int i = 0;
		layout.setCoreID(i++, 0, 1, ISetupMachineBlocks.blockDelayedCoker.blockID);
